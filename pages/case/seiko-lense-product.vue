        ...
        <div id="single">
          <div class="row gutter-width-lg single-content">
            <div class="col-xl-7 col-lg-7 col-md-7 col-sm-12">
              <div class="img">
                <div class="object-fit-cover">
                  <img src="/images/seiko-background-1.jpg" />
                </div>
              </div>
              <div class="img">
                <div class="object-fit-cover">
                  <img src="/images/seiko-background-2.jpg" />
                </div>
              </div>
              <div class="img">
                <div class="object-fit-cover">
                  <img src="/images/seiko-background-3.jpg" />
                </div>
              </div>
              <div class="img">
                <div class="object-fit-cover">
                  <img src="/images/seiko-background-4.jpg" />
                </div>
              </div>
              <div class="img">
                <div class="object-fit-cover">
                  <img src="/images/seiko-background-5.jpg" />
                </div>
              </div>
            </div>
            ...
            <div class="col-xl-5 col-lg-5 col-md-5 col-sm-12">
              <div class="sticky">
                <p class="date">
                  с <span class="large">25</span>мая 2021 по
                ...
                <div class="description mt-5">
                  <p>
                    &laquo;Seiko Lense&raquo; основана в&nbsp;2003&nbsp;году.
                    Эксклюзивный представитель ведущих мировых оптических
                    брендов на&nbsp;территории Казахстана.
                    Они&nbsp;предоставляют коллекции медицинских оправ,
                    солнцезащитных очков и&nbsp;оптических линз мировых брендов.
                  </p>
                  ...
                  <p>
                    ...
                    бота партнёрам необходимо было связываться с&nbsp;менеджером
                    компании SEIKO, который принимал заказ и&nbsp;вручную
                    оформлял в&nbsp;1С. На&nbsp;данный момент данный процесс был
                    полностью автоматизирован, заказы оформляются в&nbsp;1с,
                    происходит регулярное обновление склада, а&nbsp;менеджер
                    получает уведомление об&nbsp;оформлении заказал.
                  </p>
